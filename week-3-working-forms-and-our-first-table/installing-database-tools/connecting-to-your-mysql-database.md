...
7. Click on Test Connection and see if you're connection was successfully made. If not, check the settings for accuracy and try again. Note: You must be attached to the Internet but do not need to be on the UML VPN.
8. If you have successfully connected, click on close.&#x20;
9. Click on your connection to open the SQL Editor.
