...
3. Notice how in the .cfconfig.json file, there is a section called datasources![](<../../.gitbook/assets/image (2).png>)
4. Replace where it says \*\*DSOURCENAME\*\* with your username ( first\_last ).&#x20;
...
7. Put put the appropriate values into the .env file and save it.&#x20;
8. In CommandBox, in your ongoingWork folder, restart your server.&#x20;
